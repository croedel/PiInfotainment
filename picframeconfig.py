...
NO_FILES_IMG = "/home/pi/raspi_picframe/no-pictures.jpg"  # image to show if none selected
...
SHADER = "/home/pi/raspi_picframe/shaders/blend_new"
...
# Text overlay
TEXT1_FORMAT = "<date> (<num>/<total>) <gps>"           # Defines the format for the 1st text line
TEXT2_FORMAT = "<path>/<file> <desc>"                   # Defines the format for the 2nd text line
TEXT3_FORMAT = "<flen> (<flen35>) <exp> <fnum> <iso>"   # Defines the format for the 3rd text line
TEXT4_FORMAT = "<rating> <artist>"                      # Defines the format for the 4th text line
...
FONT_FILE = "/home/pi/raspi_picframe/fonts/NotoSans-Regular.ttf"
...
W_BACK_IMG = "/home/pi/raspi_picframe/weather_icons/weather_back_16_9.jpg"   # background image for weather info
